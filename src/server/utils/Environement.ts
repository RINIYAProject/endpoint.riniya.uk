...
export default class Environement {
    public init(): Boolean {
        ...
        else if (this.unset("SSL_KEY"))
            return this.print("SSL_KEY")
        else if (this.unset("SSL_CERT"))
            return this.print("SSL_CERT")
        else if (this.unset("GATEWAY_URL"))
            return this.print("GATEWAY_URL")
        else if (this.unset("ENDPOINT_URL"))
            return this.print("ENDPOINT_URL")
